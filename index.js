...
function buildContractClass(sourcePath) {
    ...
    const Contract = (_a = class {
        ...
        // properties
        _a.scriptPubKey = res.opcodes,
        _a);
    res.functions.map((func) => {
        // contract functions
        Contract.prototype[func.name] = function () {
            let args = Array.prototype.slice.call(arguments);
...
function getCompiledFilePath(srcPath) {
